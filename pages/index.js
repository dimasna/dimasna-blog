    ...
    <Layout>
      ...
      <section className="lg:px-44 md:px-12 xxs:px-2 -mt-8 xxs:-mt-16">
        ...
        <div className="flex bg-gray-50 p-4 rounded-lg mx-3 my-5 space-x-4">
          <p>💡</p>
          <p className="text-justify">I’m fullstack javascript developer especially in NodeJS/React, but also experienced in Vue, NextJS, SailsJS, Python (Flask), 
PHP (Laravel), Java, C++ (Arduino) and deploy it to cloud platform such as AWS, GCP and Azure (Serverless). Beside code, 
I also hands on UI/UX design. In my spare time I usually watch movie/anime.</p>
        </div>
      </section>
    </Layout>
  )
