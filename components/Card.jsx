...
export default function Card({ imgUrl, title, category, stack, date, action }) {
    return (
        <div className="flex flex-col flex-1 hover:bg-gray-100 cursor-pointer ring-gray-50 border rounded shadow min-w-50" onClick={() => action()}>
